...
\begin{enumerate}
\item Correctness: The allowable error of the output results, per module, will be less than the AVERAGE\_ERROR taken from the results of a sample of OTS solutions.
\item Maintainability: The system shall be documented with a CA, VnV, MG, and MIS.
...
\item[\label{Cons_AVERAGE_ERROR}]AVERAGE\_ERROR: 3\%
\end{itemize}
