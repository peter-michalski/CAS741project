...
The intended objective of this plan is to verify that functional requirements and non-functional requirements (NFR), as found in the Commonality Analysis (CA) titled Lattice Boltzmann Solvers (\citet{LBM_CA_PM}), have been met.\\ 
...
\paragraph{} These dynamic tests will compare output with output from the pseudo-oracle myLBM (\citet{pylbmcode}). The pseudo-oracle will have the same inputs as {\myprogname} for each test. The allowable error is AVERAGE\_ERROR, found in Section \ref{symbolpara}.
...
This test satisfies R6 and R7. It also covers a very small Reynolds number representing laminar flow.\\	
...
Test Case Derivation: This case is a comparison with the pseudo-oracle pyLBM. The output vector values of this test for pyLBM can be found in the file id3output.txt located in the OracleOutput folder. The result required for the test to pass is an average error rate between cells of the output vector (O) and (C) of less than or equal to AVERAGE\_ERROR.\\
This test satisfies R6 and R7. It also covers a very large Reynolds number representing very turbulent flow.\\	
...
Test Case Derivation: This case is a comparison with the pseudo-oracle pyLBM. The output vector values of this test for pyLBM can be found in the file id3output.txt located in the OracleOutput folder. The result required for the test to pass is an average error rate between cells of the output vector (O) and (C) of less than or equal to AVERAGE\_ERROR.\\
This test satisfies R6 and R7. It also covers the low bound for density using a density of liquid hydrogen.\\
...
Test Case Derivation: This case is a comparison with the pseudo-oracle pyLBM. The output vector values of this test for pyLBM can be found in the file id3output.txt located in the OracleOutput folder. The result required for the test to pass is an average error rate between cells of the output vector (O) and (C) of less than or equal to AVERAGE\_ERROR.\\
This test satisfies R6 and R7. It also covers the high bound for density using a density close to that of mercury.\\
...
\item{low-bulk-viscosity-test-id8\\}
...
Test Case Derivation: This case is a comparison with the pseudo-oracle pyLBM. The output vector values of this test for pyLBM can be found in the file id3output.txt located in the OracleOutput folder. The result required for the test to pass is an average error rate between cells of the output vector (O) and (C) of less than or equal to AVERAGE\_ERROR.\\
This test satisfies R6 and R7. It also covers the low bound for bulk viscosity.\\
...
\item{high-bulk-viscosity-test-id9\\}
...
Test Case Derivation: This case is a comparison with the pseudo-oracle pyLBM. The output vector values of this test for pyLBM can be found in the file id3output.txt located in the OracleOutput folder. The result required for the test to pass is an average error rate between cells of the output vector (O) and (C) of less than or equal to AVERAGE\_ERROR.\\
This test satisfies R6 and R7. It also covers the high bound for bulk viscosity.\\
...
\paragraph{Dynamic Testing - Manual:}
\paragraph{} These dynamic tests will compare output with output from the pseudo oracle myLBM (\citet{pylbmcode}). The input oracle will have the same inputs as {\myprogname} for each test. The allowable error is AVERAGE\_ERROR, found in Section \ref{symbolpara}.

\begin{enumerate}

\item{tutorial-test-id10\\}
...
\item{low-bulk-viscosity-test-id13\\}
...
\item{high-bulk-viscosity-test-id14\\}
...
\item{low-shear-viscosity-test-id15\\}
...
\item{high-shear-viscosity-test-id16\\}
...
Output/Result: This case is a check of the ability of the LBM solution to run on multiple operating systems. The result required for the test to pass is a vorticity vector printed to the screen of each instance which matches, within the allowable AVERAGE\_ERROR, the vorticity vector value found in the file id19output.txt located in the OracleOutput folder.\\
...
id2 & & & \checkmark & & & &\\
\hline
id3 & & & & & & \checkmark & \checkmark \\
\hline
id4 & & & & & & \checkmark & \checkmark \\
\hline
id5 & & & & & & \checkmark & \checkmark \\
\hline
id6 & & & & & & \checkmark & \checkmark \\
\hline
id7 & & & & & & \checkmark & \checkmark \\
\hline
id8 & & & & & & \checkmark & \checkmark \\
\hline
id9 & & & & & & \checkmark & \checkmark \\
\hline
id10 & & & & & & \checkmark & \checkmark \\
\hline
id11 & & & & & & \checkmark & \checkmark \\
\hline
id12 & & & & & & \checkmark & \checkmark \\
\hline
id13 & & & & & & \checkmark & \checkmark \\
\hline
id14 & & & & & & \checkmark & \checkmark \\
\hline
id15 & & & & & & \checkmark & \checkmark \\
\hline
id16 & & & & & & \checkmark & \checkmark \\
\hline
id16 & & & & & & \checkmark & \checkmark \\
\hline
\end{tabular}
